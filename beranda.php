    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-success">
                <strong><marquee>Selamat Datang di Sistem Informasi Data BC HPAI Tanjung Balai</marquee></strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Produk HPAI</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="15%">Kode Produk</th><th>Nama Produk</th><th>Jenis Produk</th><th>Harga</th><th>Keterangan</th>
                            </tr>
                        </thead>
                        <tbody>
