...
<html>
    <head>
        <title>Cetak Data Pembeli Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PEMBELI PERBULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                    ...
                    <thead>
                            ...
                            $sql = "SELECT * FROM tbl_pembeli WHERE substr(tgl_pembelian,1,7)='$ambilthn-$ambilbln'";
